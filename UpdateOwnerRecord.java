...
public class UpdateOwnerRecord extends JFrame{
    JLabel l1, l2, l3, l4, l5, l6, l7;
    JTextField t1, t2, t3, t4, t5, t6, t7;
    JButton b1, b2;
    owner owner;

    public UpdateOwnerRecord (owner mr){
        owner = mr;
    ...
    public class MyActionListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getActionCommand().equals("Update")){
                ...
                System.out.println(ad.updateMemberRecord(owner.getEmail(), s));
                System.out.println(f.updatePasswords(owner.getEmail(), passId));
                new OwnerDashboard();
                dispose();
